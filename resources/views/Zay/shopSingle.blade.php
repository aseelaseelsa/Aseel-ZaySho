            ...
            <div id="carousel-related-product">
                ...
                <div class="p-2 pb-3">
                    <div class="product-wap card rounded-0">
                        ...
                        <div class="card-body">
                            <a href="{{route('shopSingle')}}" class="h3 text-decoration-none">Red Clothing</a>
                ...
                <div class="p-2 pb-3">
                    <div class="product-wap card rounded-0">
                        ...
                        <div class="card-body">
                            <a href="{{route('shopSingle')}}" class="h3 text-decoration-none">White Shirt</a>
                            <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                <li>M/L/X/XL</li>
                                <li class="pt-2">
                                    <span class="product-color-dot color-dot-red float-left rounded-circle ml-1"></span>
                ...
                <div class="p-2 pb-3">
                    <div class="product-wap card rounded-0">
                        ...
                        <div class="card-body">
                            <a href="{{route('shopSingle')}}" class="h3 text-decoration-none">Oupidatat non</a>
                            <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                <li>M/L/X/XL</li>
                                <li class="pt-2">
                                    <span class="product-color-dot color-dot-red float-left rounded-circle ml-1"></span>
                ...
                <div class="p-2 pb-3">
                    <div class="product-wap card rounded-0">
                        ...
                        <div class="card-body">
                            <a href="{{route('shopSingle')}}" class="h3 text-decoration-none">Black Fashion</a>
                            <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                <li>M/L/X/XL</li>
                                <li class="pt-2">
                                    <span class="product-color-dot color-dot-red float-left rounded-circle ml-1"></span>
