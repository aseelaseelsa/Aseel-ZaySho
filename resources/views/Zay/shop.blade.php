                ...
                <ul class="list-unstyled templatemo-accordion">
                  ...
                  <li class="pb-3">
                        ...
                        <ul class="collapse show list-unstyled pl-3">
                            ...
                            <li><a class="text-decoration-none" href="{{route("shop")}}?category={{$child->id}}">
                                {{$child->name}}
                            </a></li>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <div style="hight:300px; overflow:hidden;">
                            ...
                            <div class="card-body">
                                ...
                                @if ($product->discount_price)
                                 ...
                                 <div class="price">
                                <h6 class=" text-center mb-0 text-danger ">{{$product->discount_price}}</h6>

                                <h6 class=" text-center mb-0  text-decoration-line-through text-secondary ">{{$product->price}}</h6>
                                </div>
                                @else
                                <div class="price">
...
<div class="col-12 my-5">
            ...
            <h6 class="p-4 text-center text-light  bg-secondary ">
                No Products Found
            </h6>
